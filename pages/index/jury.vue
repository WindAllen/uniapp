<template>
	<view>
		<view class="u-flex u-row-between u-m-l-30 u-m-r-30">
			<text class="title u-font-30 "><h1>陪审团</h1><h3>你认为当前事件是骗局吗？请根据你的经验做出判断。</h3>截止时间：{{time}}</text>
			<u-image width="75%" height="300rpx" src="/static/shenpan.webp"></u-image>
		</view>
		<view class="comment u-p-20 u-m-25" v-for="(res, index) in commentList" v-if:key="res.id">
